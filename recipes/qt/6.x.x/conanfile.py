...
class QtConan(ConanFile):
    ...
    options = {
        ...
        "with_x11": [True, False],
        "with_egl": [True, False],
        "with_libinput": [True, False],
        "with_tslib": [True, False],
    ...
    def config_options(self):
        ...
        if self.settings.os not in ["Linux", "FreeBSD"]:
            ...
            del self.options.with_libinput
            del self.options.with_tslib
    ...
    def requirements(self):
        ...
        if self.options.get_safe("with_libinput", False):
            self.requires("libinput/1.25.0")
        if self.options.get_safe("with_tslib", False):
            self.requires("tslib/1.23")
    ...
    def generate(self):
        ...
        # Qt's cmake files use target PkgConfig::Tslib, which is only defined if 'find_package' uses the Qt supplied FindTslib.cmake.
        # So make sure that cmake doesn't find the tslib config files generated by Conan but uses the tslib.pc also generated by Conan.
        tc.set_property("tslib", "cmake_file_name", "tslib_do_not_use")
        ...
        if cross_building(self):
            ...
            tc.cache_variables["QT_DEBUG_QT_FIND_PACKAGE"] = "1"
    ...
    def build(self):
        ...
        cmake = CMake(self)
        cmake.configure(cli_args=["-Wno-dev", "--debug-find-pkg=Tslib,tslib"])
        cmake.build()
    ...
    def package_info(self):
        ...
        if self.options.gui:
            ...
            if self.options.with_libinput:
                gui_reqs.append("libinput::libinput")
            if self.options.with_tslib:
                gui_reqs.append("tslib::tslib")
